...
; Description ...: Switches Between Normal Village and Builder Base with reduced delays
; Syntax ........: SwitchBetweenBases([$bCheckMainScreen = True[, $GoToBB = False]])
; Parameters ....: $bCheckMainScreen - Check main screen after switch
;                  $GoToBB - Force switch to Builder Base
; Return values .: True: Successfully switched Bases  -  False: Failed to switch Bases
; Author ........: Fliegerfaust (05-2017)
; Modified ......: GrumpyHog (08-2022), Moebius14 (07-2023), [Your Name] (04-2025)
...
Func SwitchBetweenBases($bCheckMainScreen = True, $GoToBB = False)
    ...
    For $i = 0 To 3
        ...
        Else
            For $j = 0 To UBound($avBoat, $UBOUND_ROWS) - 1
                ...
                If IsArray($aButtonCoords) And UBound($aButtonCoords, $UBOUND_ROWS) = 2 Then
                    ...
                    If _Sleep(100) Then Return ; Reduced from $DELAYSWITCHBASES1 (1000ms) to 100ms
        ...
        If _Sleep(500) Then Return ; Reduced from 3000ms to 500ms
        If Not $g_bRunState Then Return
    Next
